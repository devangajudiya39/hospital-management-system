...
export function useInterview() {
  ...
  const handleApiResponse = (data) => {
    ...
    // If there is a note, we should retain the previous question ID/state but show the note.
    // The API might return the exact same question with a `note`. 
    // We just set currentQuestion to the returned next_question.
  ...
  }, [sessionId, selectedLanguage, assessmentType, ayushAssessments, isLoading]);
